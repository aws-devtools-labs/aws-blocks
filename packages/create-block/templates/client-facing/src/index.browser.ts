...
//
// The stub below keeps the block importable in isomorphic code and re-exports
// the public types + errors (per the AWS Blocks browser-entry convention).
// Replace it with your real client plugin. **`packages/bb-realtime` is the
// canonical end-to-end example** — copy its client-middleware shape.
