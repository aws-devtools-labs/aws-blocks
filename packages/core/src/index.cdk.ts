...
export { BlocksStack, Scope, SandboxDisableDeletionProtection, BlocksBackend, registerConfig, finalizeConfigRegistry, synthGuard, DEFAULT_NODE_RUNTIME, blocksNodejsBundling, ensureApiGatewayAccount, type BlocksBackendProps } from './cdk/index.js';
export {
  type BlocksDefaults,
