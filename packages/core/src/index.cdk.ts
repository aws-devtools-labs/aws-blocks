...
export { BlocksStack, Scope, BuildingBlockScope, SandboxDisableDeletionProtection, BlocksBackend, registerConfig, finalizeConfigRegistry, synthGuard, DEFAULT_NODE_RUNTIME, SHARED_HANDLER_TIMEOUT_SECONDS, blocksNodejsBundling, getVpcContext, type BlocksBackendProps } from './cdk/index.js';
export type { BlocksVpcOptions, VpcRequirements, VpcContext, SubnetRole, ScopeOptions } from './cdk/index.js';
export {
  type BlocksDefaults,
  BlocksPresets,
} from './cdk/index.js';
